#!/usr/bin/env python3
"""Multi-agent shared memory with Claude API and Memtrace.

Demonstrates two Claude-powered agents sharing a Memtrace memory space:
...
def main() -> None:
    ...
    try:
        ...
        research_result = run_agent_loop(
            claude, mt, researcher_system, researcher_messages,
        ...
        summary_result = run_agent_loop(
            claude, mt, summarizer_system, summarizer_messages,
